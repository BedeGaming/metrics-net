...
namespace metrics.Tests
{
    ...
    public class MetricsTests
    {
        ...
        {
            var counter = Metrics.Counter("CounterTests", "Can_get_same_metric_when_metric_exists");
            Assert.IsNotNull(counter);

            var same = Metrics.Counter("CounterTests", "Can_get_same_metric_when_metric_exists");
        ...
        public void Can_get_all_registered_metrics_as_readonly()
        {
            ...
            Metrics.All.Add(new MetricName("CounterTests", "No way this is going to get added"),
                            new CounterMetric());
